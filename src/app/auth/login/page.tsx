  ...
  const testimonials = [
    {
      ...
      avatar: "PS",
      content: "BidZy has revolutionized how I acquire rare Indian artworks. The authentication process and secure payments give me complete confidence in high-value transactions.",
      rating: 5,
    },
    {
      name: "Rajesh Gupta",
      ...
      avatar: "RG",
      content: "As a dealer specializing in Indian antiques, BidZy's platform has expanded my reach across the country. The professional tools and analytics have increased my sales by 400%.",
      rating: 5,
    },
  ]
      ...
      <div className="flex min-h-screen relative z-10 ">
          ...
          <div className="w-full max-w-md">
            ...
            >
              <motion.div
                ...
                className="mx-auto w-20 h-20 bg-gradient-to-r from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 shadow-2xl"
              >
        ...
        <div className="hidden lg:flex lg:w-1/2 text-white relative">
          <div className="relative z-10 flex flex-col justify-center px-12 py-16 w-full">
            ...
            >
              <div className="mb-12">
                <div className="inline-flex items-center px-4 py-2 bg-emerald-500/10 backdrop-blur-md rounded-full text-sm font-medium border border-emerald-500/20 mb-6">
                ...
                <p className="text-xl text-emerald-100 leading-relaxed">
                  Experience real-time bidding, secure transactions, and access to unique items from around India.
                </p>
              </div>
              ...
              >
                {stats.map((stat, index) => (
                  <div key={stat.label} className="text-center group">
                    <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-green-600 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                {benefits.slice(0, 4).map((benefit, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-emerald-200 leading-relaxed">{benefit.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              >
                {testimonials.map((testimonial, index) => (
                  <div key={testimonial.name} className="p-6 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl">
                    ...
                    <p className="text-emerald-100 italic mb-3 text-sm leading-relaxed">
                      "{testimonial.content}"
                    </p>
                    <div className="flex items-center">
                      <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-green-600 rounded-xl flex items-center justify-center text-white font-bold text-sm mr-3 shadow-lg">
                        {testimonial.avatar}
                      </div>
                      <div>
                        <div className="font-semibold text-white text-sm">{testimonial.name}</div>
                        <div className="text-xs text-emerald-200">{testimonial.role}</div>
                      </div>
                    </div>
                  </div>
                ))}
