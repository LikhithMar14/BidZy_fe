  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-gray-950 shadow-2xl border-b border-emerald-500/20 w-full"
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex items-center space-x-3">
              <Link href="/" className="flex items-center space-x-3 group">
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 via-green-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-2xl font-black bg-gradient-to-r from-white via-emerald-200 to-green-200 bg-clip-text text-transparent">
                    BidZy
                  </h1>
                  <p className="text-xs text-gray-400 font-medium -mt-1">Premium Auctions</p>
                </div>
              </Link>
            </motion.div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:flex items-center">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 w-80 bg-gray-800/50 border border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-300 text-white placeholder-gray-400"
                  />
                </div>
              </div>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="relative">
                    <motion.button
                      ...
                      className="flex items-center space-x-2 p-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-xl transition-all duration-300 border border-gray-700/50"
                    >
                      <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-green-500 rounded-lg flex items-center justify-center text-white font-bold text-lg">
                        {user?.userName
                      ...
                      <div className="hidden md:block text-left">
                        <p className="font-semibold text-sm text-white">{user?.userName || user?.user_name}</p>
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-amber-500/20 to-yellow-500/20 rounded-full border border-amber-500/30">
                                  ...
                                  <span className="text-xs text-amber-300 font-semibold">Premium Member</span>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    className="bg-gradient-to-r from-emerald-500 via-green-500 to-teal-600 hover:from-emerald-600 hover:via-green-600 hover:to-teal-700 text-white font-bold px-6 py-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Login / Register
                  </Button>
                </motion.div>
              ...
              <motion.button
                ...
                className="lg:hidden p-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-xl transition-all duration-300 border border-gray-700/50"
              >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden bg-gray-950/95 backdrop-blur-lg border-t border-gray-800"
            >
              <div className="px-4 pt-4 pb-6 space-y-4">
                ...
                <div className="space-y-2">
                  <Link
                    href="/auctions"
                    className="block px-4 py-3 text-gray-300 hover:text-emerald-400 hover:bg-gray-800/50 rounded-xl font-medium transition-all duration-200"
                  >
                    Live Auctions
                  </Link>
                  <Link
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search auctions..."
                    className="w-full pl-10 pr-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-300 text-white placeholder-gray-400"
                  />
                </div>
